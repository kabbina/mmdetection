...
_base_ = 'C:/Users/guhan/OneDrive/Desktop/Cap stone/mmseg/mmdetection/configs/ms_rcnn/ms_rcnn_r101_caffe_fpn_1x_coco.py'
...
model = dict(
    roi_head=dict(
        ...
        mask_iou_head=dict(num_classes=9)))
...
# load_from = 'C:/Users/guhan/OneDrive/Desktop/Cap stone/mmseg/mmdetection/checkpoints/ms_rcnn_r101_caffe_fpn_1x_coco_bbox_mAP-0.404__segm_mAP-0.376_20200506_004755-b9b12a37.pth'
